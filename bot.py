...
def build_app() -> Application:
    ...
    # Media groups (albums) — have media_group_id
    group_filter = file_filter & filters.Caption("")  # won't match, use separate

    # Regular single files (no media_group_id)
    single_file_filter = file_filter & ~filters.Caption("")  # dummy, real filter below
    single_file_filter = (
